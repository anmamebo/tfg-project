...
export class EditAddressPatientsCardComponent implements OnInit {
  ...
  /** Evento que se emite cuando se edita la dirección de un paciente */
  @Output() public addressEditedEvent: EventEmitter<void> = new EventEmitter<void>(); 
