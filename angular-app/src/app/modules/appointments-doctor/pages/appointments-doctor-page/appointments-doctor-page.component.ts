...
import { breadcrumbAppointmentsData } from '@app/core/constants/breadcrumb-data.constants';
 ...
 */
@Component({
  selector: 'app-appointments-doctor-page',
  templateUrl: './appointments-doctor-page.component.html',
})
export class AppointmentsDoctorPageComponent {
  /** Título de la página. */
