 ...
 */
@Component({
  selector: 'app-view-info-status-appointments-doctor-card',
  templateUrl: './view-info-status-appointments-doctor-card.component.html',
  providers: [AppointmentService],
})
export class ViewInfoStatusAppointmentsDoctorCardComponent {
