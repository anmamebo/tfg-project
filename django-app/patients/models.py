...
class Patient(BaseModel):
  ...
  gender = models.CharField(verbose_name='Género', max_length=1, choices=(
    ('M', 'Masculino'),
    ('F', 'Femenino'),
  ))
  phone = models.CharField(verbose_name='Teléfono', max_length=20, blank=True, null=True)
  social_security = models.CharField(verbose_name='Número de seguridad social', max_length=12, unique=True, blank=True, null=True)
  address = models.OneToOneField(Address, on_delete=models.CASCADE, verbose_name='Dirección', blank=True, null=True)
